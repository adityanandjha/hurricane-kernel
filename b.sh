...
echo -e "$White***********************************************"
echo "         Compiling Hurricane=Kernel             "
echo -e "***********************************************$nocol"

LC_ALL=C date +%Y-%m-%d
kernel_dir=$PWD
build=$kernel_dir/out
export CROSS_COMPILE="/home/storm/ubertc/arm-linux-androideabi-4.9/bin/arm-linux-androideabi-"
kernel="Stock"
version="1"
vendor="Motorola"
device="Moto G"
...
export KBUILD_BUILD_USER=adityanandjha
export KBUILD_BUILD_HOST=storm_99
